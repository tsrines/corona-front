...
class StateBorders extends React.Component {
  clickHandler = e => {
    e.persist()
    let abbr = e.target.classList[0].slice(0,2)
    // .className.baseVal.slice(0, 2)
    ...
    const svgMap = (
      <svg
        ...
        <g className='outlines'>
          ...
          />
          <g className='DC state' name='DC' onClick={this.clickHandler}>
            <path
              className='DC1'
              fill='#D3D3D3'
