...
export default function genMarkersData({
  ...
  let markersData = new immutable.Range(0, count)
    .map(
      (i) =>
        new immutable.Map({
          id: "uuid_" + i,
  ...
  if (test) {
    markersData = markersData
      .push(
        new immutable.Map({
          // this marker i use to test positioning https://www.dropbox.com/s/oybq1nvogjfstlj/Screenshot%202015-05-06%2017.46.32.png?dl=0
          id: "red selo",
          lat: 59.724465,
          lng: 30.080121,
